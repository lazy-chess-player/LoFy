        ...
        case AST_BINARY_OP: {
            ...
            if (left.type == VAL_INT && right.type == VAL_INT) {
                ...
                switch (node->binary.op) {
                    case TOKEN_PLUS: v.int_val = left.int_val + right.int_val; break;
                    case TOKEN_MINUS: v.int_val = left.int_val - right.int_val; break;
                    case TOKEN_MUL: v.int_val = left.int_val * right.int_val; break;
                    case TOKEN_DIV: 
                        if (right.int_val != 0) v.int_val = left.int_val / right.int_val; 
                        else printf("Runtime Error: Division by zero\n");
                        break; 
                    default: v.type = VAL_NONE; break;
                }
                ...
                switch (node->binary.op) {
                    case TOKEN_PLUS: v.float_val = l + r; break;
                    case TOKEN_MINUS: v.float_val = l - r; break;
                    case TOKEN_MUL: v.float_val = l * r; break;
                    case TOKEN_DIV: 
                        if (r != 0) v.float_val = l / r; 
                        else printf("Runtime Error: Division by zero\n");
                        break;
                    default: v.type = VAL_NONE; break;
                }
